        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" role="search">
                    <a class="btn btn-outline-danger me-2" type="submit" href="../php/login.php">Log In</a>
                    <a class="btn btn-outline-danger me-2" type="submit" href="../php/regester.php">Sign Up</a>
                </form>
            </div>
        </div>
    </nav>
